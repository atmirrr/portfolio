  ...
  return (
    <div className="space-y-16">
      <section>
        ...
        {introComplete && (
          <Terminal
            text="Hello, I'm Amir Attari. A full-stack developer with a passion for AI, cybersecurity, and creating immersive digital experiences. I specialize in building modern web applications with a focus on performance, accessibility, and user experience."
            typingSpeed={20}
